...
import CloudImag from "@/assets/images/Cloud.webp"
import AmbientImag from "@/assets/images/ambient.webp"
import GenomicsImag from "@/assets/images/genomics.webp"
import NetworkImag from "@/assets/images/network.webp"
  ...
  return (
    <section>
       < Wrapper>
            ...
            <p className="mt-3 text-xl text-slate-600 max-w-screen-sm ">After completing the first three quarters the participants will select
            ...
            <div className="mt-10 flex flex-col-reverse lg:flex-row gap-x-6 gap-y-8">
              {/* content Left */}
               <div className="shadow-xl sticky top-28 self-start basis-8/12 rounded-xl border border-slate-200 py-8 px-8">
                   <h4 className="text-[#00616C] text-lg font-medium">Specialized Program</h4>
             ...
             <div className="flex flex-col sm:flex-row gap-4 mt-8"> 
             {
              selectedItemData?.quarters.map((item) => (
               ...
               <div>
                <h4 className="text-[#00616C] font-medium">Specialized Program</h4>
